...
public class RectifiedImage {
	...
	private WritableImage changePerspective(WritableImage image) {
		...
		Matrix matrixA = new Matrix(8, 8, new double[] {
				points[0].getX(), points[0].getY(), 1, 0, 0, 0, -points[0].getX() * 10, -points[0].getY() * 10,
				points[3].getX(), points[3].getY(), 1, 0, 0, 0, -points[3].getX() * 10, -points[3].getY() * 10,
				points[1].getX(), points[1].getY(), 1, 0, 0, 0, -points[1].getX() * (width - 10), -points[1].getY() * (width - 10),
				0, 0, 0, points[0].getX(), points[0].getY(), 1, -points[0].getX() * 10, -points[0].getY() * 10,
				0, 0, 0, points[1].getX(), points[1].getY(), 1, -points[1].getX() * 10, -points[1].getY() * 10,
				0, 0, 0, points[2].getX(), points[2].getY(), 1, -points[2].getX() * (height - 10), -points[2].getY() * (height - 10),
				0, 0, 0, points[3].getX(), points[3].getY(), 1, -points[3].getX() * (height - 10), -points[3].getY() * (height - 10),
				points[2].getX(), points[2].getY(), 1, 0, 0, 0, -points[2].getX() * (width - 10), -points[2].getY() * (width - 10),
		});

		double[] vectorB = new double[] {10, 10, (width - 10), 10, 10, (height - 10), (height - 10), (width - 10)};
